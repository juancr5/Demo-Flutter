...
//00 Pull to Refresh
class ListaPageComplete extends StatefulWidget {
  @override
  _ListaPageComplete createState() => _ListaPageComplete();
}

class _ListaPageComplete extends State<ListaPageComplete> {
  //Variables
